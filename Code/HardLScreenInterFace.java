...
public class HardLScreenInterFace {
    ...
    public HardLScreenInterFace(int CurrentScore,int fruitEaten,int scoreReverseCounter,int bestScore) {
    ...
    public void Show(GraphicsContext Graphics){
        ...
        Graphics.setFill(Color.rgb(120, 20, 20, .8));
        ...
        // اسم اللعبه
        Graphics.setFill(Color.rgb(200, 80, 80, 1));
        Graphics.setFont(Font.font("Snap ITC", FontWeight.BOLD, 26));
        Graphics.fillText("Hard Level", 575, 50);

        // قيمه البونص
        Graphics.setFill(Color.rgb(250, 20, 20, 1));
        ...
        Graphics.setFill(Color.rgb(80, 5, 5, 1));
