...
public class LowLScreenInterFace {
    ...
    public LowLScreenInterFace(int CurrentScore,int fruitEaten,int scoreReverseCounter,int bestScore) {
    ...
    public void Show(GraphicsContext Graphics){
        ...
        Graphics.fillText("Low Level", 580, 50);

        // قيمه البونص
        Graphics.setFill(Color.DARKTURQUOISE);
