...
public class MiddleLScreenInterFace {
    ...
    public MiddleLScreenInterFace(int CurrentScore,int fruitEaten,int scoreReverseCounter,int bestScore) {
    ...
    public void Show(GraphicsContext Graphics){
        ...
        Graphics.setFill(Color.rgb(20, 120, 70, .8));
        ...
        // اسم اللعبه
        Graphics.setFill(Color.rgb(90, 250, 90, 1));
        Graphics.setFont(Font.font("Snap ITC", FontWeight.BOLD, 26));
        Graphics.fillText("Middle Level", 560, 50);

        // قيمه البونص
        Graphics.setFill(Color.rgb(50, 250, 50, 1));
        ...
        Graphics.setFill(Color.rgb(20, 120, 20, .8));
