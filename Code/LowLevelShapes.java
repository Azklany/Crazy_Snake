...
public class LowLevelShapes {

    ReadandWriteHighScore LL = new ReadandWriteHighScore();
    // حيز ظهور الثعبان
    ...
    int bestScore = LL.LLReadHighScore();
    ...
    public void LowLevelShapes(GraphicsContext Graphics) {
        ...
        LowLScreenInterFace SI = new LowLScreenInterFace(CurrentScore, fruitEaten, scoreReverseCounter, bestScore);
        SI.Show(Graphics);
...
ً            When Current Score > 1000
         */
        // GoldenFruits
        if ((CurrentScore > 1000 && CurrentScore < 1200) || (CurrentScore > 2000 && CurrentScore < 2200) || (CurrentScore > 3000 && CurrentScore < 3200) || (CurrentScore > 4000 && CurrentScore < 4200) || (CurrentScore > 5000 && CurrentScore < 5200) || (CurrentScore > 6000 && CurrentScore < 6200) ) {
        ...
        //  انعكاس الثعبان
        IsReflection IR = new IsReflection(left, right, up, down, lengthOfSnake, boardX, boardY);
        IR.Reflection();
    ...
    public void GameOver(GraphicsContext Graphics) {
        ...
        LL.LLWriteHighScore(CurrentScore, bestScore);
    }
